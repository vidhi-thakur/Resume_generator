...
function Summary({summary, handleChange, nextStep, prevStep }) {
    ...
    return (
        <div>
            <form className="flex p-4 shadow-md my-12 flex-col justify-center w-10/12 mx-auto md:w-2/5 w-5/6 bg-white">
                ...
                <textarea onChange={(e) => { handleChange("summary")(e) }} defaultValue={summary} className="border border-indigo-600 bg-white px-4 py-2 mt-2.5 mb-4 mb-12 h-36" />
