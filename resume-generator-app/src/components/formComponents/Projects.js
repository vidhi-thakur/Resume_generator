        ...
        <>
            <div className="grid place-items-center content-center">
                <form className="flex p-4 shadow-md my-12 flex-col justify-center w-10/12 mx-auto md:w-2/5 w-5/6 bg-white">
                    ...
                    <input onChange={(e) => { handleChange("projectTitle")(e) }} value={projectTitle} className="border border-indigo-600 bg-white px-4 py-2 mt-2.5 mb-4" type="text" placeholder="Eg: XYZ app" required />
                    <div className="flex justify-between flex-col sm:flex-row">
                        <div className="flex flex-col flex-1 sm:mr-4">
                            <label>Project link</label>
                            <input className="border border-indigo-600 bg-white px-4 py-2 mt-2.5 mb-4" type="url" onChange={(e) => { handleChange("projectLink")(e) }} value={projectLink} placeholder="Eg: https://pigeon-go.web.app/" />
                        </div>
                        <div className="flex flex-col flex-1">
                            <label>Project date</label>
                            <input className="border border-indigo-600 bg-white px-4 py-2 mt-2.5 mb-4" type="date" onChange={(e) => { handleChange("projectDate")(e) }} value={projectDate} />
                        </div>
                    </div>
                    <label>Job description</label>
                    <textarea onChange={(e) => { handleChange("projectDescription")(e) }} defaultValue={projectDescription} className="border border-indigo-600 bg-white px-4 py-2 mt-2.5 mb-4 mb-12 h-36" />
                    <div className="flex justify-between flex-col sm:flex-row">
